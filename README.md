...
<p align="center"><em>An asynchronous Python API wrapper and scraper for porntrex.com</em></p>

<div align="center">
    <a href="https://pepy.tech/project/porntrex_api"><img src="https://static.pepy.tech/badge/porntrex_api" alt="Downloads"></a> +
    <a href="https://pepy.tech/project/unofficial-api-for-porntrex"><img src="https://static.pepy.tech/badge/unofficial-api-for-porntrex" alt="Downloads"></a>
    ...
    <a href="https://echteralsfake.me/ci/unofficial-api-for-porntrex/badge.svg"><img src="https://echteralsfake.me/ci/unofficial-api-for-porntrex/badge.svg" alt="Sync API Tests"/></a>
    </div>
...
| Category | Details |
|---|---|
| **Video Fetching** | Fetch video objects with metadata (title, duration, key, direct download urls, available qualities) |
| **Video Downloading** | RAW/direct-based downloading with quality selection |
| **Channel & Model Profiles** | Fetch channel/model profiles and extract uploaded videos lists |
| **Video Search** | Search videos by query with support for pagination and concurrency control |
...
### Have a look at the [Documentation](https://docs.echteralsfake.me/porntrex) for more details

```python
import asyncio
from porntrex_api import Client, DownloadConfigRAW
